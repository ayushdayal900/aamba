...
const LandingPage = () => {
 ...
 return (
 <div className="min-h-screen bg-card-bg font-sans text-text-secondary overflow-x-hidden">
 <main>
 {/* ── Hero ── */}
 ...
 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] aspect-square rounded-full blur-[120px] pointer-events-none -z-10 opacity-50 md:opacity-100" />
 ...
 >
 <div className="inline-flex items-center gap-2 border border-border px-4 py-2 rounded-full text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary mb-8 md:mb-12">
 <FiCheckCircle className="text-brand-accent0" /> Live on Ethereum Sepolia
 </div>

 <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black text-text-primary mb-6 md:mb-10 tracking-tighter leading-[1.1] md:leading-[0.9]">
 Microfinance <br className="hidden sm:block" />
 <span className="text-transparent bg-clip-text">Reimagined.</span>
 </h1>

 <p className="text-sm md:text-lg text-text-secondary max-w-2xl mx-auto mb-10 md:mb-16 leading-relaxed font-medium">
 ...
 className="hover: text-text-primary font-black py-5 px-8 md:px-12 rounded-2xl transition-all border border-border text-xs md:text-sm uppercase tracking-[0.2em] w-full sm:w-auto"
 >
 How it Works
 </button>
 </div>
 ...
 {/* ── Proof Bar ── */}
 <section className="py-16 md:py-24 border-y border-border bg-card-bg">
 ...
 <div className="text-2xl md:text-4xl font-black text-text-primary leading-none tracking-tighter">{s.val}</div>
 <div className="text-[8px] md:text-[10px] text-text-primary font-black uppercase tracking-widest">{s.label}</div>
 </div>
 ))}
 </div>
 </section>
 ...
 <p className="text-text-secondary0 font-black uppercase tracking-[0.3em] text-[9px] md:text-[10px] mb-4">End-to-End Protocol Flow</p>
 <h2 className="text-3xl md:text-5xl font-black text-text-primary italic tracking-tighter">How PanCred Works</h2>
 </div>

 <div className="relative">
 {/* Vertical connector line */}
 <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px via-purple-600/20 to-transparent hidden sm:block" />
 ...
 <h3 className="text-xl md:text-2xl font-black text-text-primary italic tracking-tight mb-3">{step.title}</h3>
 <p className="text-text-secondary text-sm leading-relaxed font-medium">{step.desc}</p>
 </div>
 </motion.div>
 ))}
 </div>
 ...
 <section className="py-20 md:py-32 px-4 md:px-6 bg-card-bg">
 <div className="global-container">
 <div className="text-center mb-16 md:mb-24">
 <p className="text-text-secondary0 font-black uppercase tracking-[0.3em] text-[9px] md:text-[10px] mb-4">Protocol Architecture</p>
 <h2 className="text-3xl md:text-5xl font-black text-text-primary italic tracking-tighter">The Pillars of PanCred</h2>
 </div>
 ...
 >
 <div className={`w-14 h-14 md:w-16 md:h-16 mx-auto mb-5 ${f.bg} ${f.color} rounded-2xl flex items-center justify-center text-2xl md:text-3xl group-hover:scale-110 transition-transform duration-500 `}>
 {f.icon}
 </div>
 <span className={`text-[8px] font-black uppercase tracking-[0.25em] ${f.color} block mb-3`}>{f.tag}</span>
 <h3 className="text-xl md:text-2xl font-black text-text-primary mb-4 italic tracking-tight">{f.title}</h3>
 <p className="text-text-secondary0 text-sm leading-relaxed font-medium">{f.description}</p>
 </motion.div>
 ))}
 </div>
 </div>
 ...
 <p className="text-text-secondary0 font-black uppercase tracking-[0.3em] text-[9px] md:text-[10px] mb-4">Everything Built-In</p>
 <h2 className="text-3xl md:text-5xl font-black text-text-primary italic tracking-tighter">Complete Feature Set</h2>
 </div>
 ...
 className="premium-card !p-5 flex items-center gap-3 group hover:border-border transition-all"
 >
 <div className="w-8 h-8 0/10 text-brand-accent0 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
 {f.icon}
 </div>
 <span className="text-[10px] font-black text-text-secondary uppercase tracking-wider leading-tight">{f.label}</span>
 </motion.div>
 ))}
 </div>
 </div>
 ...
 whileInView={{ opacity: 1, scale: 1 }}
 viewport={{ once: true }}
 className="via-slate-900 border border-border rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden"
 >
 <div className="absolute inset-0 rounded-[3rem] pointer-events-none" />
 <h2 className="text-3xl md:text-5xl font-black text-text-primary italic tracking-tighter mb-6">Ready to enter the protocol?</h2>
 <p className="text-text-secondary max-w-xl mx-auto mb-10 font-medium leading-relaxed">
 ...
 <footer className="py-12 md:py-20 px-4 md:px-6 text-center space-y-10 md:space-y-12 border-t border-border">
 <div className="global-container">
 <div className="flex items-center justify-center gap-3 mb-8 md:mb-10">
 <div className="w-10 h-10 border border-border rounded-xl flex items-center justify-center">
 <FiShield className="text-text-primary text-base" />
 </div>
 <span className="text-xl font-black text-text-primary tracking-widest uppercase">PanCred</span>
 </div>
 <div className="flex flex-wrap justify-center gap-6 md:gap-12 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-text-secondary0 mb-8 md:mb-10">
 <a href="#" className="hover:text-brand-accent0 transition-colors">Whitepaper</a>
 <a href="#" className="hover:text-brand-accent0 transition-colors">Protocol Status</a>
 <a href="#" className="hover:text-brand-accent0 transition-colors">Privacy</a>
 </div>
 <p className="text-text-primary text-[9px] md:text-[10px] font-medium uppercase tracking-[0.2em] max-w-xs mx-auto md:max-w-none">© 2026 PanCred Finance. Build with conviction.</p>
 </div>
 </footer>
 </div>
 );
